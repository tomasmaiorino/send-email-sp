...
import static com.tsm.example.util.ErrorCodes.INVALID_MESSAGE_SIZE;
import static com.tsm.example.util.ErrorCodes.INVALID_SENDER_NAME_SIZE;
import static com.tsm.example.util.ErrorCodes.INVALID_SUBJECT_SIZE;
import static com.tsm.example.util.ErrorCodes.REQUIRED_MESSAGE;
import static com.tsm.example.util.ErrorCodes.REQUIRED_SENDER_EMAIL;
import static com.tsm.example.util.ErrorCodes.REQUIRED_SENDER_NAME;
import static com.tsm.example.util.ErrorCodes.REQUIRED_SUBJECT;
import static com.tsm.example.util.MessageTestBuilder.LARGE_MESSAGE;
import static com.tsm.example.util.MessageTestBuilder.LARGE_SENDER_EMAIL;
import static com.tsm.example.util.MessageTestBuilder.LARGE_SENDER_NAME;
import static com.tsm.example.util.MessageTestBuilder.LARGE_SUBJECT;
import static com.tsm.example.util.MessageTestBuilder.SMALL_MESSAGE;
import static com.tsm.example.util.MessageTestBuilder.SMALL_SENDER_NAME;
import static com.tsm.example.util.MessageTestBuilder.SMALL_SUBJECT;
