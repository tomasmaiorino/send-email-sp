...
# 2 - docker create --link postgres --link eureka --link config-server -e profile=local -e port=40666 -e custom_mvn_parameters=-Dspring.datasource.url=jdbc:postgresql://postgres:5432/send_email -e custom_mvn_parameters_2=-Deureka.client.serviceUrl.defaultZone=http://eureka:8761/eureka -e branch_name=eureka -p 40666:40666 -v /home/tomas/.m2:/root/.m2 --name send-eureka send-eureka
# **********************************************************************************************************************
